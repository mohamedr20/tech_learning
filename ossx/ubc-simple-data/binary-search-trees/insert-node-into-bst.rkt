...
#reader(lib "htdp-intermediate-reader.ss" "lang")((modname insert-node-into-bst) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
...
;; Adds a node to the given tree. The node should be inserted into the proper place in the tree

;(define (insert 35 "gik" false) (make-node 35 "gik" false false)) ; If the root node doesn't exsist, create the root
