...
#reader(lib "htdp-beginner-reader.ss" "lang")((modname cartesian-distance) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
...
;; Number Number Number Number -> Number
;; Given a set of 4 points, calculate the distance between those points
...
(check-within (distance 1 0 0 1) (sqrt 2) 1.4142135623730951)
