...
; (list "Showdown" "Brute Squad" "Nova") is a good list of ordered wins for the semifinals,
...
;; Takes a bracket and a list of teams and checks wheter or not the winner of the bracket (team-won) beat
;; those teams in reverse order on the way to winning the current round.
