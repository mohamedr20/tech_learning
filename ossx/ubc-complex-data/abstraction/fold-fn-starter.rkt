...
#reader(lib "htdp-intermediate-reader.ss" "lang")((modname fold-fn-starter) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
(require 2htdp/image)
...
(check-expect (fold * 1 (list 1 2 4)) 8)
...
(define (all-names e)
  (local [(define (c1 name data los) (cons name los))]    
